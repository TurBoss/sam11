...
function vt52Paint(unit, remove, ch)
{
    ...
    {  // If not in VT52 mode take existing textarea and format into screen array
        ...
        for (i = vt52.screen.length; i < 24; i++)
        {  // extend short screen
            vt52.screen[i] = "";
        }
        screenUpdates++;
    ...
    if (vt52.screen[vt52.row].length < vt52.col)
